...
def run_wizard() -> None:
    ...
    if sys.stdout.isatty():
        ...
        print()
        print(f"{Colors.BRIGHT_WHITE}  Start everything (bot + API + dashboard):{Colors.RESET}")
        print(f"    {Colors.CYAN}python src/run.py{Colors.RESET}")
        print()
        print(f"{Colors.BRIGHT_WHITE}  Bot only (no API/dashboard):{Colors.RESET}")
        print(f"    {Colors.CYAN}python src/run.py --only bot{Colors.RESET}")
        print()
        ...
        print()
        print("  Start everything (bot + API + dashboard):")
        print("    python src/run.py")
        print()
        print("  Bot only (no API/dashboard):")
        print("    python src/run.py --only bot")
        print()
        print("  Documentation:")
